...
frshDir=0
clangbuild="CC=clang CXX=clang++ CPP=clang-cpp"
egcc_build="CC=egcc CXX=eg++ CPP=egcpp"
gcc__build="CC=gcc CXX=g++ CPP=cpp"
clang_cnfg="MAKE=gmake CXX=clang++ CC=clang"
egcc__cnfg="MAKE=gmake CXX=eg++ CC=egcc"
gcc___cnfg="MAKE=gmake"
...
#	https://raw.githubusercontent.com/bitsko/bitcoin-related/main/get-bdb-5.3.sh
	...
	if [ ! -d "$DOWNLOADDIR" ]; then
    		...
    		--prefix=$BDB_PREFIX "$clangbuild" > $WORKING_DIR/config.log 2>&1
